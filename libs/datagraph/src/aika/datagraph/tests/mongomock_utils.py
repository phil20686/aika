...
try:
    ...
    from mongomock.helpers import parse_uri, split_hosts
...
def patch(servers="localhost", on_new="error", patch_target="pymongo.MongoClient"):
    ...
    Args:
        ...
        patch_target: the target to be patched
    """
    ...
    return mock.patch(patch_target, _PersistentClient)
